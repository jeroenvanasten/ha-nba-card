...
export function renderPre(c) {
    ...
    <style>
        ...
        .gameday { font-size: 1.2em; height: 1.2em; }
        .gamedate { font-size: 1em; height: 1em; }
        .gametime { font-size: 1em; height: 1em; }
        .pre-row1 { font-weight: bold; font-size: 1.1em; height: 1.1em; margin: 6px 0 2px; }
    ...
    <ha-card>
        <div class="card">
            ...
            <div class="pre-row1">
                ...
                <div class="odds">${c.pre3}</div>
            </div>
            <div class="pre-row2">
                <div class="venue">${c.venue}</div>
                <div class="overunder"> ${c.location}</div>
            </div>
        </div>
    </ha-card>
